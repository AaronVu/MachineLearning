...
class Ui_Form(QtWidgets.QWidget):
    ...
    def setupUi(self, Form):
        ...
        self.pwdEdit = QtWidgets.QLineEdit(self.widget_3)
        ...
        self.codeEdit = QtWidgets.QLineEdit(self.widget_3)
        ...
        self.remCheckBox = QtWidgets.QCheckBox(self.widget_3)
        ...
        self.msgTip = QtWidgets.QLabel(self.widget_3)
...
"color: rgb(255, 0, 0);"))
        ...
        self.minBtn = QtWidgets.QPushButton(self.widget_4)
...
class CodeLabel(QtWidgets.QLabel):
